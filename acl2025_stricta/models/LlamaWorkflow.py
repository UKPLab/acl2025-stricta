...
class LlamaWorkflow(LlmWorkflow):
    def __init__(self,
                 workflow,
                 model_name,
                 gen_config=None,
        ...
        assert not multimodal, "Llama models cannot be run in multimodal mode! Figures are not supported."
    ...
    def get_name(self):
        return f"{self.model_name} + {self.model_subpath.replace('/', '_')}"
